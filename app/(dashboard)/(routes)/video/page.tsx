        ...
        <div className='px-4 lg:px-8'>
            <div>
                        ...
                        <FormField name="prompt" render={({field}) => (
                            <FormItem className='col-span-12 lg:col-span-10 '>
                                <FormControl className='m-0 p-0 '>
                                    ...
                                    disabled={isLoading}
                                    placeholder='Clown fish swimming in a pond'
                                    {...field}
                                    />
                                </FormControl>
                            </FormItem>
                ...
                <div className='space-y-4 mt-4'>
                    ...
                    { !video && !isLoading && (
                        <Empty label='No video generatred!' />
                    )}

                    {video && (
                        <video src={video} controls className='w-full aspect-video mt-8 rounded-lg border bg-black' />
                    )}
                </div>
            </div>
        </div>
